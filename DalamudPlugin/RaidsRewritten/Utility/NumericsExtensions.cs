...
public static class NumericsExtensions
{
    ...
    {
        euler = new Vector3(MathHelper.DegToRad(euler.X), MathHelper.DegToRad(euler.Y), MathHelper.DegToRad(euler.Z));
    ...
    public static Vector3 ToEuler(this Quaternion r)
    {
        ...
        return new Vector3(MathHelper.RadToDeg(yaw), MathHelper.RadToDeg(pitch), MathHelper.RadToDeg(roll));
    }
